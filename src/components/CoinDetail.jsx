...
import {
  Button, Container, HStack, Radio, RadioGroup, VStack, Text, Image, Stat, StatArrow, StatHelpText, StatLabel, StatNumber, Badge, Box, Progress
          ...
          loader ?
            ...
            <>
              ...
              <HStack p={'4'} overflowX={'auto'}>
                {
                  btns.map((i) => (
                    <Button key={i} onClick={() => switchChart(i)} bg={'blackAlpha.900'} color={'white'} disabled={days === i}>
                      {i}
                    </Button>
                  ))
                }
